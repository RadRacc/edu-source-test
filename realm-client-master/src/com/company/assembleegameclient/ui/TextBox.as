package com.company.assembleegameclient.ui
{
   ...
   public class TextBox extends Sprite
   {
      ...
      public function addText(guild:String, name:String, text:String) : void
      {
         var textBoxLine:TextBoxLine = new TextBoxLine(getTimer(),guild,name,-1,-1,"",false,text);
         lines_.push(textBoxLine);
         this.refreshStatusBox();
      }
      
      public function addTextFull(guild:String, name:String, objectId:int, numStars:int, recipient:String, text:String) : void
      {
         var fromMe:Boolean = recipient != "" && name == this.gs_.model.getName();
         var toMe:Boolean = recipient == this.gs_.model.getName();
         var textBoxLine:TextBoxLine = new TextBoxLine(getTimer(),guild, name,objectId,numStars,recipient,toMe,text);
         lines_.push(textBoxLine);
         this.refreshStatusBox();
         if(toMe)
         {
